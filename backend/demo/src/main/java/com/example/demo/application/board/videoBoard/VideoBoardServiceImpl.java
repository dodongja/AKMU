...
//
//import com.example.demo.application.board.BaseBoardService;
...
//import com.example.demo.domain.videoBoard.repository.VideoBoardLikeRepository;
...
//        //int형은 메모리를 4byte 차지하고 boolean는 1byte 차지하기 때문에 boolean으로 고쳐야 효율적인거같음
//
